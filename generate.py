...
def generate(
    ...
    if multiple_ads:
        ...
        results_dir = os.path.join(
            ...
            "lstm_hc",
            dataset,
            str(qsar_features.__name__) + ad_names,
    ...
    scoring_function = ADScoringFunction(
        clf, qsar_features, ad, ad_features, df_train.smiles, multiple_ads
    )
    ...
    smiles_history = optimizer.generate_optimized_molecules(
        scoring_function, 100, starting_population=df_train.smiles, get_history=True
    )
